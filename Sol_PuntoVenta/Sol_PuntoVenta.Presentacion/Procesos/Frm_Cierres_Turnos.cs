...
namespace Sol_PuntoVenta.Presentacion.Procesos
{
    public partial class Frm_Cierres_Turnos : Form
    {
        ...
        private void Btn_abrirturno_Click(object sender, EventArgs e)
        {
            ...
            if (this.nCodigo_pv>0)
            {
                try
                {
                    ...
                    if (Opcion == DialogResult.Yes)
                    {
                        ...
                        if (cFecha_ct == string.Empty) //asigno fecha de hoy y turno 1 en caso que no tengamos historial de cierre del pv.
                        {
                        ...
                        {
                            this.Estado_gestion_turno_pv(this.nCodigo_pv);
                            MessageBox.Show("El turno ha sido aperturado correctamente",
                                            "Aviso del Sistema",
                                            MessageBoxButtons.OK,
                                            MessageBoxIcon.Exclamation);
                        }
            ...
            {
                MessageBox.Show("No se tiene datos del punto de Venta que se intenta aperturar", 
        ...
        private void Btn_cerrarturno_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult Opcion;
                Opcion = MessageBox.Show("¿Cerrar el turno ahora?", "Aviso del Sistema",
